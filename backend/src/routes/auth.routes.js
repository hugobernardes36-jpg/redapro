...
const { authRateLimiter, passwordResetRateLimiter, emailVerificationRateLimiter } = require('../middlewares/rateLimit.middleware');
...
router.get('/verify-email', emailVerificationRateLimiter, verificarEmail);
router.post('/resend-verification', emailVerificationRateLimiter, csrfProtection, reenviarVerificacao);
